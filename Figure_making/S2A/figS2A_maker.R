...
## INPUT
fulldf_file <- "correlation_table.tsv"
...
## OUTPUT
pico_df <- small_df[ which( small_df$row %in% c( "C002_S3_3f", "C002_S4_3f", "C004_S3_3f", "C004_S4_3f", "C002_S3_4f10K", "C002_S4_4f10K", "C004-rep1_S3_4f10K", "C004-rep1_S4_4f10K", "C004-rep2_S3_4f10K", "C004-rep2_S4_4f10K", "C002_S2L_4f", "C002_S2S_4f", "C004-rep1_S2L_4f", "C004-rep1_S2S_4f", "C004-rep2_S2L_4f", "C004-rep2_S2S_4f" ) ), ]
pico_df$row <- factor(
    pico_df$row,
    levels = c(
        "C004-rep2_S4_4f10K", "C004-rep1_S4_4f10K", "C002_S4_4f10K",
        "C004_S4_3f",  "C002_S4_3f",
        "C004-rep2_S3_4f10K", "C004-rep1_S3_4f10K", "C002_S3_4f10K",
        "C004_S3_3f", "C002_S3_3f",
        "C004-rep2_S2L_4f", "C004-rep1_S2L_4f", "C002_S2L_4f",
        "C004-rep2_S2S_4f", "C004-rep1_S2S_4f", "C002_S2S_4f"
    )
)

g1 <- ggplot( pico_df, aes( y = row, x = col ) ) +
    geom_tile( aes( fill = corr_val ), colour = "white" ) +
    geom_text( size = 15, aes( label = round( corr_val, 2 ) ) ) +
    scale_fill_gradient2( high = "#d8b365", mid = "#f5f5f5", low = "#5ab4ac", limits = c( -1, 1 ) ) + 
    theme_bw() +
...
ggsave( filename = "figS2A.pdf" ), width = 18, height = 15 )
